...
setwd("~/Genomes/corals/Pocillopora.verrucosa/01_Pver_lib4_Genome_properties")
...
pdf("Khmer_spectra_jellyfish.pdf") 
# Create a plot
par(mar = c(6.5, 6.5, 3, 0.5), mgp = c(4.5, 1, 0))
plot(Pver_31mer[4:300,], type="l", col="gray18", las=1, lwd = 2, lty=4, xlab="Kmer-Coverage", ylab="Kmer counts frequency", main="K-hmer spectra")
